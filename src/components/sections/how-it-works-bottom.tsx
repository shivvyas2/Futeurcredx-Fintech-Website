...
const comparisons = [
  ...
  },
  {
    ...
    items: ['→ Visibility', '→ Staged exposure', '→ Documented progression', '→ Explainable outcomes'],
  },
  {
    name: 'Without LumiqAI',
    company: 'LOST REVENUE',
    image: '/investors/3.webp',
    items: ['• Declined applicants disappear', '• Future revenue is lost upstream', '• Platforms compete downstream for survivors'],
  },
  {
    name: 'With LumiqAI',
    company: 'CREATED REVENUE',
    image: '/investors/4.webp',
    items: ['• Declined applicants become progression pipelines', '• Readiness is cultivated, not guessed', '• Future revenue is created inside your platform'],
  },
  {
    name: 'Designed for Sponsors',
    company: 'NOT A LOOPHOLE',
    image: '/investors/5.webp',
    items: ['• Respect sponsor bank constraints', '• Align with compliance frameworks', '• Produce auditable decision trails', '• Allow immediate intervention'],
  },
];
  ...
  return (
    <section className="container max-w-5xl py-12">
      ...
      <p className="text-muted-foreground mt-4 text-lg">
        When uncertainty appears, most systems default to blind decisions. Risk does not increase. It becomes observable.
      </p>
      ...
      <div className="mt-12 text-center">
        <p className="text-muted-foreground text-sm">
          LumiqAI — The Intelligence Layer That Turns &ldquo;Unbankable&rdquo; Into &ldquo;Proven&rdquo;
        </p>
