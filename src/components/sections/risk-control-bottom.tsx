...
const features = [
  {
    ...
    items: [
      "✓ non-credit by default",
      "✓ capped if any instrument attached",
      "✓ milestone-gated",
      "✓ reversible",
      "✓ fully documented",
      "✓ sponsor-aligned",
  ...
  },
  {
    ...
    items: [
      "→ staged exposure (or none)",
      "→ longitudinal behavior observation",
      "→ explicit readiness milestones",
  ...
  },
  {
    ...
    items: [
      "• progression caps",
      "• stage freezing",
      "• manual escalation approval",
      "• instant rollback",
      "• sponsor-governed constraints",
    ],
  },
  {
    name: "Auditability",
  ...
  return (
    <section className="container max-w-5xl py-12">
      ...
      <p className="text-muted-foreground mt-4 text-lg">
        Risk does not increase. It becomes legible. Control is designed in — not
        layered on later.
      </p>
      ...
      <div className="mt-16 rounded-2xl border bg-slate-50 p-8 dark:bg-slate-900">
        ...
        <ul className="text-muted-foreground mt-4 space-y-2">
          <li>
            • Platforms without a progression layer only see businesses after
            readiness exists
          </li>
        ...
        <p className="mt-4 font-medium">
          Once a business earns readiness inside another system, switching
          becomes costly — operationally and psychologically. That loss is
          permanent.
        </p>
      </div>
      ...
      <div className="mt-16 rounded-2xl border bg-slate-50 p-8 dark:bg-slate-900">
        ...
        <p className="mt-2 text-xl font-medium">
          It decides whether uncertainty becomes a blind rejection — or a
          governed process.
        </p>
        <p className="text-muted-foreground mt-4">
